...
Здесь опубликовано, то чем я занимался во втором семестре по этому предмету.
Всего практических работ было 7. Работы подразделялись по работе с простыми сортировкам 
<br>
Работы:
<br>
